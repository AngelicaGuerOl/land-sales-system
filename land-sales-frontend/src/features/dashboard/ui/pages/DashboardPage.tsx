...
export function DashboardPage() {
  ...
  return <PageContainer><Stack spacing={{ xs: 2.5, md: 3 }}>
    ...
    <Stack spacing={1}><Typography variant="h5" sx={{ fontWeight: 800 }}>Disponibilidad de lotes</Typography><Typography color="text.secondary">Estado actual de los terrenos de la lotificación activa.</Typography></Stack>
